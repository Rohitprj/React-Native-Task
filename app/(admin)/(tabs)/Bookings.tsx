...
// import { useNavigation } from "@react-navigation/native";
// import { useLocalSearchParams } from "expo-router";
// // IMPORTANT: Replace this with your actual axiosInstance import and configuration
// // For example: import axiosInstance from '@/utils/axiosInstance';
// // import Cookies from 'js-cookie';

// // // Mock axiosInstance for demonstration. Replace with your actual setup.
// // const axiosInstance = axios.create({
// //   baseURL: import.meta.env.VITE_BASE_URL,
// //   // Add other default headers or interceptors if needed
// // });

// // // Request Interceptor (Example - assuming you have an interceptor setup for auth token)
...
//         phone: booking.customer?.phone || "N/A",
//         bookingsTypes: booking.bookingType || "N/A", // Added to match DisplayBookingItem type
//         status: booking.status === 1 ? "COMPLETED" : "PENDING", // Corrected status mapping
//         paid: booking.paid, // Directly use the paid boolean
//         store: booking.store.name,
//         packageName: booking.package?.name || "N/A",
//         packageType: booking.package?.type || "N/A",
...
//           phone: booking.customer?.phone || "N/A",
//           bookingsTypes: booking.bookingType || "N/A",
//           status: booking.status === 1 ? "COMPLETED" : "PENDING", // Map numeric status to string
//           paid: booking.paid, // Direct boolean
//           store: booking.store.name,
//           packageName: booking.package?.name || "N/A",
//           packageType: booking.package?.type || "N/A",
//           overs: booking.overs || 0,
...
//     try {
//       const response = await axiosInstance.get(
//         `${import.meta.env.VITE_BASE_URL}/admin/booking/payment/mark/${selectedBooking.id}`
//       );
//       if (response.data.valid) {
//         setMessageModalContent({ message: "Payment marked as done successfully!", type: 'success' });
//         setShowMessageModal(true);
...
//     try {
//       const response = await axiosInstance.put(
//         `${import.meta.env.VITE_BASE_URL}/admin/booking/${selectedBooking.id}`,
//         { playedOvers: overs }
//       );
//       if (response.data.valid) {
//         setMessageModalContent({ message: "Overs played updated successfully!", type: 'success' });
...
//                     styles.columnText,
//                     { width: 70 },
//                     item.status === "COMPLETED" ? styles.paid : styles.unpaid, // Adjusted based on new status type
//                   ]}
//                 >
//                   {item.status}
//                 </Text>
